...
const ResetPasswordForm = props => {
    ...
    return (<>
        ...
        : null}
                            ...
                            <style_1.Label htmlFor="key">
                                {t('key')}
                                <style_1.Input type="key" name="key"/>
                                <style_1.FieldErrorRow name="key" ErrorMessageProp={props.message}/>
                                {props.message && props.message.includes('key')
        ? props.message.split(':').pop()
        : null}
                            </style_1.Label>
