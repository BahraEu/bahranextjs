...
const materialReact_1 = require("../../../mu/materialReact");
const ButtonStyle = {
    button: {
        minHeight: "auto",
        minWidth: "auto",
        backgroundColor: materialReact_1.grayColor,
        color: "#FFFFFF",
    ...
    white: {
        "&,&:focus,&:hover,&:visited": {
            ...
            color: materialReact_1.grayColor
        }
    },
    twitter: {
    ...
    simple: {
        ...
        "&$primary": {
            "&,&:focus,&:hover,&:visited": {
                color: materialReact_1.primaryColor
            }
        },
        "&$info": {
            "&,&:focus,&:hover,&:visited": {
                color: materialReact_1.infoColor
            }
        },
        "&$success": {
            "&,&:focus,&:hover,&:visited": {
                color: materialReact_1.successColor
            }
        },
        "&$warning": {
            "&,&:focus,&:hover,&:visited": {
                color: materialReact_1.warningColor
            }
        },
        "&$rose": {
            "&,&:focus,&:hover,&:visited": {
                color: materialReact_1.roseColor
            }
        },
        "&$danger": {
            "&,&:focus,&:hover,&:visited": {
                color: materialReact_1.dangerColor
            }
        },
        "&$twitter": {
            "&,&:focus,&:hover,&:visited": {
...
//# sourceMappingURL=buttonStyle.jsx.map